...
import { Play, Copy, Check, LogOut, Share2 } from "lucide-react";
      ...
      {roomCode && (
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <div className="flex items-center gap-1.5 bg-[#212121] border border-[#3F3F3F] rounded-full px-3 py-1">
            <span className="text-[10px] font-medium text-[#AAAAAA] uppercase tracking-wider hidden sm:inline">
              Room:
            </span>

            <code className="bg-transparent text-white font-mono text-xs sm:text-sm font-bold tracking-wider">
              {roomCode}
            </code>
